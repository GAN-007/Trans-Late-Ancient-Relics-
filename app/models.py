...
class ProgressRequest(BaseModel):
    # Kept for backwards compatibility; the server binds writes to the authenticated user.
    learner: str = Field(default="self", min_length=1, max_length=80)
...
class PronunciationRequest(TextRequest):
    profile: Literal["classroom", "consonantal", "research"] = "classroom"
